...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\linewidth]{flow-2.png} % suzuki
  \caption{画面遷移（仮）}
  \label{fig:disflow}

\end{figure}

\input{chap3/chap3-5/chap3-5-1.tex}
\input{chap3/chap3-5/chap3-5-2.tex}
\input{chap3/chap3-5/chap3-5-3.tex}
